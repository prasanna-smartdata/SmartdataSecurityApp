...
- Create Angular project with ng: `ng new smartdatasecurityapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`smartdatasecurityapp.client.esproj`).
